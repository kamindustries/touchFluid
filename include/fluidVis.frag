...
// Official HSV to RGB conversion a
...
void main()
{
	...
	//if (cd.r > 1.0) cd.r = 1.0;
	//if (cd.g > 1.0) cd.g = 1.0;
	//if (cd.b > 1.0) cd.b = 1.0;
	//if (cd.a > 1.0) cd.a = 1.0;
	...
	float mag = abs(sqrt(velU*velU + velV*velV));
